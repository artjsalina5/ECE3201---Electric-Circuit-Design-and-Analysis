...
\begin{figure}[H] \centering \includegraphics[width=0.5\textwidth]{lab1diode}
...
\begin{figure}[H] \centering \includegraphics[width=0.5\textwidth]{lab01/cir1}
...
\begin{figure}[H] \centering \includegraphics[width=0.5\textwidth]{lab01/cir2}
...
\begin{figure}[H] \centering \includegraphics[width=0.5\textwidth]{lab01/cir3}
...
\begin{figure}[H] \centering \includegraphics[width=0.5\textwidth]{lab01/cir4}
...
\begin{figure}[H] \centering \includegraphics[width=1.0\textwidth]{lab01/cir1input}
	\caption{Input Waveform to Circuit One} \label{fig:cir1input}
\end{figure}

\begin{figure}[H] \centering \includegraphics[width=1.0\textwidth]{lab01/cir1output}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{lab01/cir1output2}
...
measured DC below the ideal estimate. The conduction angle at smaller peak input voltages is more affected due to the formula:
\[
  \theta = sin^{-1}(\frac{V_d}{V_p})
\]
\subsection{Circuit Two}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{lab01/cir2input.png}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{lab01/cir2outputmax.png}
	\caption{Output Max Waveform of Circuit Two} \label{fig:cir2outputmax}
\end{figure}

\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{lab01/cir2outputmean.png}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{lab01/cir3pos.png}
	\caption{Positive Transformer Half Side Input to Circuit 3} \label{fig:cir3pos}
\end{figure}

\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{lab01/cir3neg.png}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{lab01/cir3out.png}
...
\begin{figure}[H] \centering \includegraphics[width=0.8\textwidth]{lab01/cir4output.png}
